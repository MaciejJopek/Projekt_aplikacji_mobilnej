...
public class laweczkawykres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laweczkawykres);
    ...
    public void SaveToDatabase(){
        ...
        db.saveDate(xvalue,yvalue, "Laweczka");
        addDataToGraph();
        barChart.invalidate();
    ...
    public void addDataToGraph(){
        ...
        final ArrayList<String> ydata = db.queryYData("'Laweczka'");

        for (int i = 0;i<db.queryYData("'Laweczka'").size();i++){
            BarEntry newBarEntry = new BarEntry(i, Float.parseFloat(db.queryYData("'Laweczka'").get(i)));
            yVals.add(newBarEntry);
        }
        final ArrayList<String> xVals = new ArrayList<String>();
        final ArrayList<String> xdata = db.queryXData("'Laweczka'");

        for (int i = 0; i < db.queryXData("'Laweczka'").size();i++){
